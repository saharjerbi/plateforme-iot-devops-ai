...
class AgentConfig:
    ...
    def __init__(self) -> None:
        ...
        self._model: str = os.getenv("GROQ_MODEL", self.DEFAULT_MODEL)
        self._max_tokens: int = self._parse_int(
            os.getenv("GROQ_MAX_TOKENS", str(self.DEFAULT_MAX_TOKENS)),
            "GROQ_MAX_TOKENS"
        )
        self._temperature: float = self._parse_float(
            os.getenv("GROQ_TEMPERATURE", str(self.DEFAULT_TEMPERATURE)),
            "GROQ_TEMPERATURE"
        )
